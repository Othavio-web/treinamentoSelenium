...
public class FileOperation {
    private static final String DIR_PATH_PROPERTIES = System.getProperty("user.dir")+File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"Properties"+File.separator;
    ...
    public static Properties getProperties(String fileName) {
        ...
        try {
            ...
            System.out.println("Não foi possivel carregar o arquivo de propriedade");
        }
        return prop;
    }
